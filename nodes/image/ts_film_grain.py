    ...
    def define_schema(cls) -> IO.Schema:
        return IO.Schema(
            ...
            inputs=[
                ...
                IO.Float.Input("grain_size", default=1.0, min=0.1, max=5.0, step=0.1, display_mode=IO.NumberDisplay.slider, tooltip="Scale of the grain particles. Higher values give coarser, larger grain."),
                IO.Float.Input("grain_intensity", default=0.065, min=0.0, max=0.5, step=0.005, display_mode=IO.NumberDisplay.slider, tooltip="Overall strength of the grain effect. 0 = no grain."),
                IO.Float.Input("grain_speed", default=0.5, min=0.0, max=1.0, step=0.01, display_mode=IO.NumberDisplay.slider, tooltip="For image batches/video: 0 = static grain shared across frames, 1 = fully animated per-frame grain."),
