...
# надёжная общая (кратна и 8, и 16, и 32) и 112 у Qwen — он живёт на сетке 56,
# завязанной на собственный энкодер, а удвоение вдобавок держит сторону латента
# чётной, чтобы патчам трансформера не пришлось ничего добивать.
SNAP_PX = 16
