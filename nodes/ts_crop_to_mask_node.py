...
def gaussian_blur_mask(mask_tensor_batch, blur_amount, device):
    """
    РџСЂРёРјРµРЅСЏРµС‚ Р“Р°СѓСЃСЃРѕРІРѕ СЂР°Р·РјС‹С‚РёРµ Рє Р‘РђРўР§РЈ С‚РµРЅР·РѕСЂРѕРІ РјР°СЃРєРё, РёСЃРїРѕР»СЊР·СѓСЏ СЂР°Р·РґРµР»СЏРµРјСѓСЋ СЃРІРµСЂС‚РєСѓ РґР»СЏ СЌС„С„РµРєС‚РёРІРЅРѕСЃС‚Рё.
    Args:
        mask_tensor_batch (torch.Tensor): РўРµРЅР·РѕСЂ РјР°СЃРѕРє (B, H, W), РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ float32.
        blur_amount (int): РЎС‚РµРїРµРЅСЊ СЂР°Р·РјС‹С‚РёСЏ. РРЅС‚РµСЂРїСЂРµС‚РёСЂСѓРµС‚СЃСЏ РєР°Рє РїСЂРёРјРµСЂРЅРѕРµ Р·РЅР°С‡РµРЅРёРµ СЃРёРіРјС‹.
                           РўР°РєР¶Рµ РІР»РёСЏРµС‚ РЅР° СЂР°Р·РјРµСЂ СЏРґСЂР°.
        device (torch.device): РЈСЃС‚СЂРѕР№СЃС‚РІРѕ (РЅР°РїСЂРёРјРµСЂ, 'cpu' РёР»Рё 'cuda'), РЅР° РєРѕС‚РѕСЂРѕРј РІС‹РїРѕР»РЅСЏСЋС‚СЃСЏ РѕРїРµСЂР°С†РёРё.
    Returns:
        torch.Tensor: Р Р°Р·РјС‹С‚С‹Р№ С‚РµРЅР·РѕСЂ РјР°СЃРѕРє (B, H, W).
    """
    if blur_amount <= 0:
        return mask_tensor_batch # Р Р°Р·РјС‹С‚РёРµ РЅРµ С‚СЂРµР±СѓРµС‚СЃСЏ, РІРѕР·РІСЂР°С‰Р°РµРј РёСЃС…РѕРґРЅС‹Рµ РјР°СЃРєРё

    # РџСЂРµРѕР±СЂР°Р·СѓРµРј blur_amount РІ Р·РЅР°С‡РµРЅРёРµ СЃРёРіРјС‹ РґР»СЏ С„СѓРЅРєС†РёРё Р“Р°СѓСЃСЃР°
    sigma = float(blur_amount) / 3.0
    
    # Р’С‹С‡РёСЃР»СЏРµРј СЂР°Р·РјРµСЂ СЏРґСЂР° РЅР° РѕСЃРЅРѕРІРµ СЃРёРіРјС‹. РћРЅРѕ РґРѕР»Р¶РЅРѕ Р±С‹С‚СЊ РЅРµС‡РµС‚РЅС‹Рј.
    kernel_size = int(6 * sigma) + 1
    if kernel_size % 2 == 0:
        kernel_size += 1 # Р“Р°СЂР°РЅС‚РёСЂСѓРµРј РЅРµС‡РµС‚РЅС‹Р№ СЂР°Р·РјРµСЂ СЏРґСЂР°

    # РЈР±РµРґРёРјСЃСЏ, С‡С‚Рѕ СЂР°Р·РјРµСЂ СЏРґСЂР° РЅРµ РјРµРЅРµРµ 3 РґР»СЏ Р·РЅР°С‡РёРјРѕРіРѕ СЂР°Р·РјС‹С‚РёСЏ
    kernel_size = max(3, kernel_size)

    # РЎРѕР·РґР°РµРј 1D СЏРґСЂРѕ Р“Р°СѓСЃСЃР° РЅР° СѓРєР°Р·Р°РЅРЅРѕРј СѓСЃС‚СЂРѕР№СЃС‚РІРµ
    ax = torch.arange(-kernel_size // 2 + 1., kernel_size // 2 + 1., device=device, dtype=torch.float32)
    gauss = torch.exp((-ax ** 2) / (2 * sigma ** 2))
    kernel_1d = gauss / gauss.sum() # РќРѕСЂРјР°Р»РёР·СѓРµРј, С‡С‚РѕР±С‹ СЃСѓРјРјР° Р±С‹Р»Р° СЂР°РІРЅР° 1

    # Р’С…РѕРґ mask_tensor_batch РёРјРµРµС‚ С„РѕСЂРјСѓ B, H, W. РќСѓР¶РЅРѕ РїСЂРµРѕР±СЂР°Р·РѕРІР°С‚СЊ РІ [B, C, H, W] РґР»СЏ F.conv2d, РіРґРµ C=1.
    input_tensor_for_conv = mask_tensor_batch.unsqueeze(1) # [B, 1, H, W]

    # --- РџСЂРёРјРµРЅСЏРµРј СЂР°Р·РґРµР»СЏРµРјСѓСЋ СЃРІРµСЂС‚РєСѓ ---
    # 1. Р“РѕСЂРёР·РѕРЅС‚Р°Р»СЊРЅРѕРµ СЂР°Р·РјС‹С‚РёРµ
    # РЇРґСЂРѕ РґР»СЏ РіРѕСЂРёР·РѕРЅС‚Р°Р»СЊРЅРѕР№ СЃРІРµСЂС‚РєРё: [1, 1, 1, K] (out_channels, in_channels/groups, kernel_height, kernel_width)
    horizontal_kernel = kernel_1d.view(1, 1, 1, -1)
    
    blurred_h = F.conv2d(input_tensor_for_conv, 
                         horizontal_kernel, 
                         padding=(0, kernel_size // 2), # Р”РѕРїРѕР»РЅРµРЅРёРµ С‚РѕР»СЊРєРѕ РїРѕ С€РёСЂРёРЅРµ
                         groups=1) # РіСЂСѓРїРїС‹=1 РґР»СЏ СЃС‚Р°РЅРґР°СЂС‚РЅРѕР№ СЃРІРµСЂС‚РєРё
    
    # 2. Р’РµСЂС‚РёРєР°Р»СЊРЅРѕРµ СЂР°Р·РјС‹С‚РёРµ
    # РЇРґСЂРѕ РґР»СЏ РІРµСЂС‚РёРєР°Р»СЊРЅРѕР№ СЃРІРµСЂС‚РєРё: [1, 1, K, 1]
    vertical_kernel = kernel_1d.view(1, 1, -1, 1)

    blurred_v = F.conv2d(blurred_h, 
                         vertical_kernel, 
                         padding=(kernel_size // 2, 0), # Р”РѕРїРѕР»РЅРµРЅРёРµ С‚РѕР»СЊРєРѕ РїРѕ РІС‹СЃРѕС‚Рµ
                         groups=1)

    return blurred_v.squeeze(1) # Р’РѕР·РІСЂР°С‰Р°РµРј Рє С„РѕСЂРјРµ [B, H, W]


def box_blur_mask(mask_tensor_batch, blur_amount, device):
    """
    РџСЂРёРјРµРЅСЏРµС‚ Box СЂР°Р·РјС‹С‚РёРµ Рє Р‘РђРўР§РЈ С‚РµРЅР·РѕСЂРѕРІ РјР°СЃРєРё, РёСЃРїРѕР»СЊР·СѓСЏ СЂР°Р·РґРµР»СЏРµРјСѓСЋ СЃРІРµСЂС‚РєСѓ.
    Args:
        mask_tensor_batch (torch.Tensor): РўРµРЅР·РѕСЂ РјР°СЃРѕРє (B, H, W), РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ float32.
        blur_amount (int): РЎС‚РµРїРµРЅСЊ СЂР°Р·РјС‹С‚РёСЏ (РїСЂРёРјРµСЂРЅС‹Р№ СЂР°РґРёСѓСЃ).
        device (torch.device): РЈСЃС‚СЂРѕР№СЃС‚РІРѕ (РЅР°РїСЂРёРјРµСЂ, 'cpu' РёР»Рё 'cuda').
    Returns:
        torch.Tensor: Р Р°Р·РјС‹С‚С‹Р№ С‚РµРЅР·РѕСЂ РјР°СЃРѕРє (B, H, W).
    """
    if blur_amount <= 0:
    ...
    # Р Р°Р·РјРµСЂ СЏРґСЂР° РґР»СЏ box blur: 2 * radius + 1
    kernel_size = int(blur_amount * 2) + 1
    
    # РЈР±РµРґРёРјСЃСЏ, С‡С‚Рѕ СЂР°Р·РјРµСЂ СЏРґСЂР° РЅРµ РјРµРЅРµРµ 3 РґР»СЏ Р·РЅР°С‡РёРјРѕРіРѕ СЂР°Р·РјС‹С‚РёСЏ, РµСЃР»Рё blur_amount > 0
    if blur_amount > 0:
        kernel_size = max(3, kernel_size)
    else: # Р•СЃР»Рё blur_amount Р±С‹Р» 0, РЅРѕ РїРѕС‡РµРјСѓ-С‚Рѕ РЅРµ РІРµСЂРЅСѓР»СЃСЏ РІС‹С€Рµ, С‚Рѕ kernel_size=1
        return mask_tensor_batch


    # РЎРѕР·РґР°РµРј 1D СЏРґСЂРѕ "РєРѕСЂРѕР±РєРё" (РІСЃРµ РµРґРёРЅРёС†С‹, РЅРѕСЂРјР°Р»РёР·РѕРІР°РЅРЅС‹Рµ)
...
class TSCropToMask:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                # Р”РѕР±Р°РІР»РµРЅРёРµ РїР°СЂР°РјРµС‚СЂРѕРІ РІ РєРѕРЅРµС† РґР»СЏ СЃРѕРІРјРµСЃС‚РёРјРѕСЃС‚Рё
    ...
    def crop(self, images, mask, padding, divide_by, max_resolution, fixed_mask_frame_index, interpolation_window_size, force_gpu, fixed_crop_size=False, fixed_width=1024, fixed_height=1024):
        # РћРїСЂРµРґРµР»РµРЅРёРµ С†РµР»РµРІРѕРіРѕ СѓСЃС‚СЂРѕР№СЃС‚РІР°
        ...
        # РџРµСЂРµРјРµС‰РµРЅРёРµ РІС…РѕРґРЅС‹С… С‚РµРЅР·РѕСЂРѕРІ РЅР° С†РµР»РµРІРѕРµ СѓСЃС‚СЂРѕР№СЃС‚РІРѕ
        ...
        # РџСЂРѕРІРµСЂСЏРµРј, СЏРІР»СЏСЋС‚СЃСЏ Р»Рё РІСЃРµ РјР°СЃРєРё РІ Р±Р°С‚С‡Рµ РїСѓСЃС‚С‹РјРё РёР»Рё РѕРґРЅРѕС‚РѕРЅРЅС‹РјРё.
        all_masks_are_solid = True
        for i in range(mask.shape[0]):
            m = mask[i]
            if m.numel() > 0: # РЈР±РµР¶РґР°РµРјСЃСЏ, С‡С‚Рѕ РІ СЃСЂРµР·Рµ РјР°СЃРєРё РµСЃС‚СЊ СЌР»РµРјРµРЅС‚С‹
                if m.min() != m.max():
                    all_masks_are_solid = False
                    break
        
        if all_masks_are_solid:
            print("TSCropToMask: Р’СЃРµ РІС…РѕРґРЅС‹Рµ РјР°СЃРєРё РїСѓСЃС‚С‹Рµ РёР»Рё РѕРґРЅРѕС‚РѕРЅРЅС‹Рµ. РџСЂРѕРїСѓСЃРєР°РµРј РѕР±СЂРµР·РєСѓ Рё РІРѕР·РІСЂР°С‰Р°РµРј РёСЃС…РѕРґРЅС‹Рµ РёР·РѕР±СЂР°Р¶РµРЅРёСЏ.")
            crop_data = []
        ...
        # --- Р›РѕРіРёРєР° Fixed Crop Size (СЃРѕС…СЂР°РЅРµРЅРёРµ РїСЂРѕРїРѕСЂС†РёР№) ---
        if fixed_crop_size:
            ...
            for r in smoothed_regions:
                ...
                # Р—Р°Р¶РёРј РІ РіСЂР°РЅРёС†С‹ РѕСЂРёРіРёРЅР°Р»СЊРЅРѕРіРѕ РёР·РѕР±СЂР°Р¶РµРЅРёСЏ
    ...
    def restore(self, original_images, cropped_images, crop_data, blur, blur_type, force_gpu):
        ...
        for i in range(original_images.shape[0]):
            ...
            if y_end_orig > y_start_orig and x_end_orig > x_start_orig:
                ...
                if blur > 0:
                    # --- РЈРњРќРђРЇ РњРђРЎРљРђ РЎ РЈР§Р•РўРћРњ Р“Р РђРќРР¦ РР—РћР‘Р РђР–Р•РќРРЇ ---
                    # Р•СЃР»Рё РѕР±Р»Р°СЃС‚СЊ РєСЂРѕРїР° РїСЂРёРјС‹РєР°РµС‚ Рє РєСЂР°СЋ РєР°РґСЂР° Р±Р»РёР¶Рµ С‡РµРј РЅР° blur, 
                    # РјС‹ РЅРµ СЃСѓР¶Р°РµРј РјР°СЃРєСѓ СЃ СЌС‚РѕР№ СЃС‚РѕСЂРѕРЅС‹.
                    ...
                    # РЎСѓР¶Р°РµРј С‚РѕР»СЊРєРѕ С‚Рµ СЃС‚РѕСЂРѕРЅС‹, РєРѕС‚РѕСЂС‹Рµ РќР• Сѓ РєСЂР°СЏ РєР°РґСЂР°
