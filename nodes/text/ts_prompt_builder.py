...
def ts_prompts_dir():
    pack_root = ts_find_pack_root()
    preferred = os.path.join(pack_root, "nodes", TS_PROMPTS_DIRNAME)
    if os.path.isdir(preferred):
        return preferred
    return os.path.join(pack_root, TS_PROMPTS_DIRNAME)
...
@_register_post("/ts_prompt_builder/config")
