"""TS Audio Loader node with ffmpeg-backed load, record, preview, and crop support."""
...
NODE_CLASS_MAPPINGS = {
    "TS_AudioLoader": TS_AudioLoader,
    "TS_AudioPreview": TS_AudioPreview,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    "TS_AudioLoader": "TS Audio Loader",
    "TS_AudioPreview": "TS Audio Preview",
}
