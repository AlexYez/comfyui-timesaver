...
class TS_Color_Match:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "reference": ("IMAGE", {"description": "Р РµС„РµСЂРµРЅСЃ РґР»СЏ РїРѕРґР±РѕСЂР° С†РІРµС‚Р°. РњРѕР¶РЅРѕ Р±Р°С‚С‡; РїСЂРё batch=1 Рё РІРєР»СЋС‡РµРЅРЅРѕРј reuse_reference СЃС‚Р°С‚РёСЃС‚РёРєРё РїРµСЂРµРёСЃРїРѕР»СЊР·СѓСЋС‚СЃСЏ.", "tooltip": "Р­С‚Р°Р»РѕРЅ, Рє РєРѕС‚РѕСЂРѕРјСѓ РїСЂРёРІРѕРґРёС‚СЃСЏ С†РІРµС‚. РџСЂРё batch=1 РјРѕР¶РЅРѕ РїРµСЂРµРёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ СЃС‚Р°С‚РёСЃС‚РёРєРё РґР»СЏ РІСЃРµРіРѕ РІРёРґРµРѕ."}),
                "target": ("IMAGE", {"description": "РР·РѕР±СЂР°Р¶РµРЅРёРµ(СЏ), Рє РєРѕС‚РѕСЂРѕРјСѓ РїСЂРёРјРµРЅСЏРµС‚СЃСЏ РїРµСЂРµРЅРѕСЃ С†РІРµС‚Р°.", "tooltip": "РљР°РґСЂС‹/РёР·РѕР±СЂР°Р¶РµРЅРёСЏ, РєРѕС‚РѕСЂС‹Рµ Р±СѓРґСѓС‚ РїРµСЂРµРєСЂР°С€РµРЅС‹ РїРѕ СЂРµС„РµСЂРµРЅСЃСѓ."}),
                "mode": (_SUPPORTED_MODES, {"default": "mkl", "description": "РђР»РіРѕСЂРёС‚Рј РјР°С‚С‡РёРЅРіР°: mkl (СЃСЂРµРґРЅРёРµ/РєРѕРІР°СЂРёР°С†РёСЏ) РёР»Рё sinkhorn (OT РїРѕ СЃСЌРјРїР»Р°Рј).", "tooltip": "mkl Р±С‹СЃС‚СЂРµРµ Рё СЃС‚Р°Р±РёР»СЊРЅРµРµ; sinkhorn С‚РѕС‡РЅРµРµ, РЅРѕ С‚СЏР¶РµР»РµРµ РїРѕ РїР°РјСЏС‚Рё Рё РІСЂРµРјРµРЅРё."}),
                "device": (_SUPPORTED_DEVICES, {"default": "auto", "description": "РЈСЃС‚СЂРѕР№СЃС‚РІРѕ РІС‹С‡РёСЃР»РµРЅРёР№: auto РёСЃРїРѕР»СЊР·СѓРµС‚ GPU РїСЂРё РЅР°Р»РёС‡РёРё, РёРЅР°С‡Рµ CPU.", "tooltip": "auto = GPU РµСЃР»Рё РµСЃС‚СЊ, РёРЅР°С‡Рµ CPU. Р’ СЂРµР¶РёРјРµ GPU Р±РѕР»СЊС€РёРµ С‚РµРЅР·РѕСЂС‹ РѕСЃС‚Р°СЋС‚СЃСЏ РЅР° CPU РґР»СЏ Р·Р°С‰РёС‚С‹ РѕС‚ OOM."}),
                "strength": ("FLOAT", {"default": 1.0, "min": 0.0, "max": 1.0, "step": 0.1, "description": "РЎРёР»Р° РїСЂРёРјРµРЅРµРЅРёСЏ С†РІРµС‚РѕРєРѕСЂСЂРµРєС†РёРё (0 = Р±РµР· РёР·РјРµРЅРµРЅРёР№, 1 = РїРѕР»РЅР°СЏ РєРѕСЂСЂРµРєС†РёСЏ).", "tooltip": "РџРѕР·РІРѕР»СЏРµС‚ РјСЏРіРєРѕ СЃРјРµС€РёРІР°С‚СЊ РёСЃС…РѕРґРЅРёРє Рё СЃРєРѕСЂСЂРµРєС‚РёСЂРѕРІР°РЅРЅС‹Р№ С†РІРµС‚."}),
                "enable": ("BOOLEAN", {"default": True, "description": "Р’РєР»СЋС‡РёС‚СЊ РѕР±СЂР°Р±РѕС‚РєСѓ (false = РІРµСЂРЅСѓС‚СЊ target Р±РµР· РёР·РјРµРЅРµРЅРёР№).", "tooltip": "Р•СЃР»Рё РІС‹РєР»СЋС‡РµРЅРѕ, РЅРѕРґР° РІРѕР·РІСЂР°С‰Р°РµС‚ РІС…РѕРґРЅРѕР№ target Р±РµР· РєРѕСЂСЂРµРєС†РёРё."}),
                "match_mask": (_SUPPORTED_MASK_MODES, {"default": "none", "description": "РћР±Р»Р°СЃС‚СЊ, РїРѕ РєРѕС‚РѕСЂРѕР№ СЃС‡РёС‚Р°РµС‚СЃСЏ РјР°С‚С‡РёРЅРі (none/rectangle/ellipse).", "tooltip": "rectangle/ellipse Р±РµСЂСѓС‚ С‚РѕР»СЊРєРѕ РєСЂР°СЏ РёР·РѕР±СЂР°Р¶РµРЅРёСЏ С€РёСЂРёРЅРѕР№ mask_size, РґР»СЏ СЃС‚Р°Р±РёР»РёР·Р°С†РёРё."}),
                "mask_size": ("INT", {"default": 32, "min": 0, "max": 512, "step": 1, "description": "РўРѕР»С‰РёРЅР° СЂР°РјРєРё РІ РїРёРєСЃРµР»СЏС… РґР»СЏ match_mask.", "tooltip": "РСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ С‚РѕР»СЊРєРѕ РїСЂРё match_mask = rectangle РёР»Рё ellipse."}),
                "compute_max_side": ("INT", {"default": _DEFAULT_COMPUTE_MAX_SIDE, "min": 0, "max": 4096, "step": 1, "description": "РњР°РєСЃРёРјР°Р»СЊРЅР°СЏ СЃС‚РѕСЂРѕРЅР° РґР»СЏ СЂР°СЃС‡С‘С‚Р° С‚СЂР°РЅСЃС„РѕСЂРјР°С†РёРё. 0 = Р±РµР· РґР°СѓРЅСЃРєРµР№Р»Р°. РџСЂРёРјРµРЅСЏРµС‚СЃСЏ Рё Рє fix, Рё Рє reference.", "tooltip": "РЎС‡РёС‚Р°С‚СЊ A,b РЅР° СѓРјРµРЅСЊС€РµРЅРЅРѕР№ РєРѕРїРёРё (РЅР°РїСЂРёРјРµСЂ 512вЂ“1024). Р­РєРѕРЅРѕРјРёС‚ РїР°РјСЏС‚СЊ РїСЂРё 4K, РєР°С‡РµСЃС‚РІРѕ РїРѕС‡С‚Рё РЅРµ СЃС‚СЂР°РґР°РµС‚."}),
                "mkl_sample_points": ("INT", {"default": _DEFAULT_MKL_SAMPLE_POINTS, "min": 0, "max": 2000000, "step": 1, "description": "РЎСЌРјРїР»РёСЂРѕРІР°РЅРёРµ РїРёРєСЃРµР»РµР№ РґР»СЏ MKL. 0 = РІСЃРµ РїРёРєСЃРµР»Рё. РњРµРЅСЊС€Рµ = Р±С‹СЃС‚СЂРµРµ Рё РјРµРЅСЊС€Рµ РїР°РјСЏС‚СЊ.", "tooltip": "Р РµРєРѕРјРµРЅРґСѓРµС‚СЃСЏ 200kвЂ“500k. РџСЂРё 0 Р±РµСЂСѓС‚СЃСЏ РІСЃРµ РїРёРєСЃРµР»Рё, С‡С‚Рѕ РјРѕР¶РµС‚ РІС‹Р·РІР°С‚СЊ OOM РЅР° 4K."}),
                "sinkhorn_max_points": ("INT", {"default": _DEFAULT_SINKHORN_MAX_POINTS, "min": 0, "max": 65536, "step": 1, "description": "Р–С‘СЃС‚РєРёР№ Р»РёРјРёС‚ С‚РѕС‡РµРє РґР»СЏ Sinkhorn. 0 = РґРµС„РѕР»С‚РЅС‹Р№ Р»РёРјРёС‚.", "tooltip": "Р”Р»СЏ 4K РѕР±С‹С‡РЅРѕ 1024вЂ“2048. РЎР»РёС€РєРѕРј Р±РѕР»СЊС€РѕРµ Р·РЅР°С‡РµРЅРёРµ РјРѕР¶РµС‚ РґР°С‚СЊ OOM."}),
                "reuse_reference": ("BOOLEAN", {"default": True, "description": "Р•СЃР»Рё reference batch=1, СЃС‡РёС‚Р°С‚СЊ РµРіРѕ СЃС‚Р°С‚РёСЃС‚РёРєРё/СЃСЌРјРїР»С‹ РѕРґРёРЅ СЂР°Р· Рё РёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ РґР»СЏ РІСЃРµС… РєР°РґСЂРѕРІ.", "tooltip": "РЈСЃРєРѕСЂСЏРµС‚ Рё СЃС‚Р°Р±РёР»РёР·РёСЂСѓРµС‚ РІРёРґРµРѕ, РєРѕРіРґР° СЂРµС„РµСЂРµРЅСЃ РѕРґРёРЅ РЅР° РІРµСЃСЊ Р±Р°С‚С‡."}),
                "chunk_size": ("INT", {"default": 4, "min": 0, "max": 256, "step": 1, "description": "РћР±СЂР°Р±РѕС‚РєР° Р±Р°С‚С‡Р° РїРѕ С‡Р°РЅРєР°Рј. 0 = РІРµСЃСЊ Р±Р°С‚С‡. РњРµРЅСЊС€Рµ - РЅРёР¶Рµ РїРёРє РїР°РјСЏС‚Рё, РЅРѕ РјРµРґР»РµРЅРЅРµРµ.", "tooltip": "Р РµРєРѕРјРµРЅРґСѓРµС‚СЃСЏ 4вЂ“8 РґР»СЏ РґР»РёРЅРЅС‹С… 4K РІРёРґРµРѕ. 0 РѕР±СЂР°Р±Р°С‚С‹РІР°РµС‚ РІРµСЃСЊ Р±Р°С‚С‡ СЂР°Р·РѕРј."}),
                "logging": ("BOOLEAN", {"default": False, "description": "Р’РєР»СЋС‡РёС‚СЊ РїРѕРґСЂРѕР±РЅРѕРµ Р»РѕРіРёСЂРѕРІР°РЅРёРµ СЃС‚Р°РґРёР№ Рё РїР°РјСЏС‚Рё (РґР»СЏ РѕС‚Р»Р°РґРєРё OOM).", "tooltip": "РџСЂРё РІРєР»СЋС‡РµРЅРёРё РїРёС€РµС‚ РІ РєРѕРЅСЃРѕР»СЊ СЃС‚Р°РґРёРё РѕР±СЂР°Р±РѕС‚РєРё, РЅРѕРјРµСЂ С‡Р°РЅРєР° Рё СЃРѕСЃС‚РѕСЏРЅРёРµ РїР°РјСЏС‚Рё GPU."}),
            },
        }
