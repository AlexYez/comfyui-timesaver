...
class TS_Qwen3_VL_V3:
    ...
    _MODEL_SIZES_B = {
        ...
        "Qwen/Qwen3.5-2B": 2,
        "Qwen/Qwen3.5-4B": 4,
        "huihui-ai/Huihui-Qwen3.5-2B-abliterated": 2,
        "huihui-ai/Huihui-Qwen3.5-4B-abliterated": 4,
        "huihui-ai/Huihui-Qwen3.5-4B-Claude-4.6-Opus-abliterated": 4,
        ...
        return {
            "required": {
                "model_name": (cls._MODEL_LIST, {
                    ...
                    "tooltip": "Р’С‹Р±РµСЂРёС‚Рµ РјРѕРґРµР»СЊ РёР· СЃРїРёСЃРєР°. Р”Р»СЏ РёСЃРїРѕР»СЊР·РѕРІР°РЅРёСЏ СЃС‚РѕСЂРѕРЅРЅРёС… РјРѕРґРµР»РµР№ РІС‹Р±РµСЂРёС‚Рµ 'Custom (manual)'."
                }),
                "custom_model_id": ("STRING", {
                    "multiline": False, 
                    "default": "",
                    "tooltip": "ID СЂРµРїРѕР·РёС‚РѕСЂРёСЏ РЅР° HuggingFace (РЅР°РїСЂРёРјРµСЂ, 'Qwen/Qwen2-VL-7B-Instruct') РёР»Рё РїРѕР»РЅС‹Р№ Р»РѕРєР°Р»СЊРЅС‹Р№ РїСѓС‚СЊ."
                }),
                "hf_token": ("STRING", {
                    "multiline": False, 
                    "default": "",
                    "tooltip": "Р’Р°С€ С‚РѕРєРµРЅ HuggingFace (Write/Read) РґР»СЏ СЃРєР°С‡РёРІР°РЅРёСЏ РјРѕРґРµР»РµР№. РћСЃС‚Р°РІСЊС‚Рµ РїСѓСЃС‚С‹Рј РґР»СЏ РїСѓР±Р»РёС‡РЅС‹С… РјРѕРґРµР»РµР№."
                }),
                "system_preset": (preset_options, {
                    "default": preset_options[0] if preset_options else "Your instruction",
                    "tooltip": "РџСЂРµРґСѓСЃС‚Р°РЅРѕРІРєР° СЃРёСЃС‚РµРјРЅРѕРіРѕ РїСЂРѕРјРїС‚Р°. Р’Р»РёСЏРµС‚ РЅР° РїРѕРІРµРґРµРЅРёРµ Рё СЃС‚РёР»СЊ РѕС‚РІРµС‚РѕРІ РјРѕРґРµР»Рё."
                }),
                "prompt": ("STRING", {
                    "multiline": True, 
                    "default": "",
                    "tooltip": "Р’Р°С€ Р·Р°РїСЂРѕСЃ (РїСЂРѕРјРїС‚) Рє РјРѕРґРµР»Рё."
                }),
                "seed": ("INT", {
                    "default": 42, 
                    "min": 0, 
                    "max": 0xffffffffffffffff,
                    "tooltip": "РЎРёРґ РґР»СЏ РІРѕСЃРїСЂРѕРёР·РІРѕРґРёРјРѕСЃС‚Рё СЂРµР·СѓР»СЊС‚Р°С‚РѕРІ РіРµРЅРµСЂР°С†РёРё."
                }),
                "max_new_tokens": ("INT", {
                    "default": 512, 
                    "min": 64, 
                    "max": 8192, 
                    "step": 64,
                    "tooltip": "РњР°РєСЃРёРјР°Р»СЊРЅРѕРµ РєРѕР»РёС‡РµСЃС‚РІРѕ С‚РѕРєРµРЅРѕРІ РІ РѕС‚РІРµС‚Рµ (РґР»РёРЅР° С‚РµРєСЃС‚Р°)."
                }),
                "precision": (precision_options, {
                    "default": "auto",
                    "tooltip": "РўРѕС‡РЅРѕСЃС‚СЊ РІРµСЃРѕРІ. 'auto' РІС‹Р±РёСЂР°РµС‚ РѕРїС‚РёРјР°Р»СЊРЅСѓСЋ. int4/int8 С‚СЂРµР±СѓСЋС‚ СѓСЃС‚Р°РЅРѕРІР»РµРЅРЅРѕРіРѕ bitsandbytes."
                }),
                "attention_mode": (attention_options, {
                    "default": "auto",
                    "tooltip": "РўРёРї РІРЅРёРјР°РЅРёСЏ. 'flash_attention_2' Р±С‹СЃС‚СЂРµРµ Рё СЌРєРѕРЅРѕРјРёС‡РЅРµРµ, РЅРѕ С‚СЂРµР±СѓРµС‚ СЃРѕРІРјРµСЃС‚РёРјРѕР№ GPU."
                }),
                "offline_mode": ("BOOLEAN", {
                    "default": False,
                    "tooltip": "Р—Р°РїСЂРµС‚РёС‚СЊ СЃРєР°С‡РёРІР°РЅРёРµ. РСЃРїРѕР»СЊР·РѕРІР°С‚СЊ С‚РѕР»СЊРєРѕ С„Р°Р№Р»С‹, СѓР¶Рµ РЅР°С…РѕРґСЏС‰РёРµСЃСЏ РІ РїР°РїРєРµ models/LLM."
                }),
                "unload_after_generation": ("BOOLEAN", {
                    "default": False,
                    "tooltip": "Р’С‹РіСЂСѓР¶Р°С‚СЊ РјРѕРґРµР»СЊ РёР· РїР°РјСЏС‚Рё СЃСЂР°Р·Сѓ РїРѕСЃР»Рµ РіРµРЅРµСЂР°С†РёРё. Р­РєРѕРЅРѕРјРёС‚ VRAM, РЅРѕ Р·Р°РјРµРґР»СЏРµС‚ РїРѕРІС‚РѕСЂРЅС‹Рµ Р·Р°РїСѓСЃРєРё."
                }),
                "enable": ("BOOLEAN", {
                    "default": True,
                    "tooltip": "Р’РєР»СЋС‡РёС‚СЊ РѕР±СЂР°Р±РѕС‚РєСѓ. Р•СЃР»Рё РІС‹РєР»СЋС‡РµРЅРѕ вЂ” РїСЂРѕСЃС‚Рѕ РїРµСЂРµРґР°РµС‚ РёР·РѕР±СЂР°Р¶РµРЅРёСЏ РЅР° РІС‹С…РѕРґ Р±РµР· РёР·РјРµРЅРµРЅРёР№."
                }),
                "max_image_size": ("INT", {
                    "default": 1024, 
                    "min": 64, 
                    "max": 4096, 
                    "step": 32,
                    "tooltip": "РњР°РєСЃРёРјР°Р»СЊРЅС‹Р№ СЂР°Р·РјРµСЂ СЃС‚РѕСЂРѕРЅС‹ РёР·РѕР±СЂР°Р¶РµРЅРёСЏ. Р‘РѕР»СЊС€РёРµ СЂР°Р·СЂРµС€РµРЅРёСЏ С‚СЂРµР±СѓСЋС‚ Р±РѕР»СЊС€Рµ VRAM."
                }),
                "video_max_frames": ("INT", {
                    ...
                    "max": 256, 
                    "step": 4,
                    "tooltip": "РЎРєРѕР»СЊРєРѕ РєР°РґСЂРѕРІ РёР· РІРёРґРµРѕ РїРµСЂРµРґР°РІР°С‚СЊ РјРѕРґРµР»Рё. Р‘РѕР»СЊС€Рµ РєР°РґСЂРѕРІ = Р»СѓС‡С€Рµ РїРѕРЅРёРјР°РЅРёРµ РєРѕРЅС‚РµРєСЃС‚Р°, РЅРѕ Р±РѕР»СЊС€Рµ СЂР°СЃС…РѕРґ РїР°РјСЏС‚Рё."
                }),
            },
            "optional": {
                "image": ("IMAGE", {"tooltip": "Р’С…РѕРґРЅРѕРµ РёР·РѕР±СЂР°Р¶РµРЅРёРµ."}),
                "video": ("IMAGE", {"tooltip": "Р’С…РѕРґРЅРѕР№ РІРёРґРµРѕРїРѕС‚РѕРє (Р±Р°С‚С‡ РёР·РѕР±СЂР°Р¶РµРЅРёР№)."}),
                "custom_system_prompt": ("STRING", {
                    "multiline": True, 
                    "forceInput": True,
                    "tooltip": "Р’Р°С€ СЃРёСЃС‚РµРјРЅС‹Р№ РїСЂРѕРјРїС‚. Р Р°Р±РѕС‚Р°РµС‚, РµСЃР»Рё РІ 'system_preset' РІС‹Р±СЂР°РЅРѕ 'Your instruction'."
                }),
            }
        }
    ...
    def _presets_path(cls):
        preferred = os.path.join(cls._CURRENT_DIR, "qwen_3_vl_presets.json")
        if os.path.exists(preferred):
            return preferred
        legacy = os.path.join(os.path.dirname(cls._CURRENT_DIR), "qwen_3_vl_presets.json")
        return legacy
