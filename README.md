...
| Наговорить текст в поле прямо из микрофона | `TS_VoiceRecognition` |
...
| `TS_VoiceRecognition` | Записывает речь с микрофона в браузере и вставляет распознанный текст в поле ноды. | `STRING` |
...
### Микрофон не работает в ноде TS Voice Recognition
...
| Dictate text from the browser microphone | `TS_VoiceRecognition` |
...
| `TS_VoiceRecognition` | Records speech in the browser and inserts recognized text into the node. | `STRING` |
...
### Microphone Does Not Work In TS Voice Recognition
