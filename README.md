...
В паке сейчас **57 нод**, все на ComfyUI V3 API. Их можно условно разделить так:
...
The pack currently contains **57 nodes**, all on the ComfyUI V3 API. They can be grouped like this:
