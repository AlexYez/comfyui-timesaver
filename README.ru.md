...
| 🎨 | **[Ideogram](#ideogram)** | 1 | Визуальный дизайнер JSON-промптов для Ideogram 4 — блоки текста/объектов, двухуровневые пресеты лейаут+стиль, живые цвета палитры, выход ширина/высота, RU/EN, импорт/экспорт |
