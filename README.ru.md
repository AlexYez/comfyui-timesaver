...
**Дружелюбный набор из 64 нод, чтобы убрать рутину из ваших ComfyUI-графов.**

> 13 из них — ноды TS Image Studio: сама студия плюс маркеры и бэкенды, которыми она управляет. Отдельно ниже они не расписаны, справочник охватывает остальные 51.
...
[![Версия](https://img.shields.io/badge/version-12.0.1-blue.svg)](pyproject.toml)
...
> Все 64 ноды используют **ComfyUI V3 API** (`comfy_api.v0_0_2.IO` — pinned namespace для стабильности).
>
...
├─ nodes/                  # 68 модулей: 64 ноды + 4 без нод
