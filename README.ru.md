...
**Дружелюбный набор из 60 нод, чтобы убрать рутину из ваших ComfyUI-графов.**
...
[![Версия](https://img.shields.io/badge/version-9.46-blue.svg)](pyproject.toml)
...
> Все 60 нод используют **ComfyUI V3 API** (`comfy_api.v0_0_2.IO` — pinned namespace для стабильности).
>
