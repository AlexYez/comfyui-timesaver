...
**Дружелюбный набор из 61 ноды, чтобы убрать рутину из ваших ComfyUI-графов.**
...
[![Версия](https://img.shields.io/badge/version-9.91-blue.svg)](pyproject.toml)
...
> Все 61 нода используют **ComfyUI V3 API** (`comfy_api.v0_0_2.IO` — pinned namespace для стабильности).
>
