...
**Дружелюбный набор из 63 нод, чтобы убрать рутину из ваших ComfyUI-графов.**

> 13 из них — ноды TS Image Studio: сама студия плюс маркеры и бэкенды, которыми она управляет. Отдельно ниже они не расписаны, справочник охватывает остальные 66.
...
[![Версия](https://img.shields.io/badge/version-11.0.0-blue.svg)](pyproject.toml)
...
> Все 63 ноды используют **ComfyUI V3 API** (`comfy_api.v0_0_2.IO` — pinned namespace для стабильности).
>
...
├─ nodes/                  # 67 модулей: 63 ноды + 4 без нод
